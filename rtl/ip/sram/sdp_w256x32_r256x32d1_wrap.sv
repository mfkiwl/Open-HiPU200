...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_w258x32_r258x32d1_wrap.sv
...
module sdp_w256x32_r256x32d1_wrap (
    input           wr_clk_i,
    input           we_i,
    input [7:0]     waddr_i,
    input [31:0]    wdata_i,
...
`ifdef PLATFORM_XILINX
    sdp_w256x32_r256x32d1 sdp_w256x32_r256x32d1_inst (
        .clka           (wr_clk_i),
        .ena            (1'b1),
...
`ifdef PLATFORM_ASIC
    ...
    TSDN28HPCPA256X32M8MW sdp_w256x32_r256x32d1_inst (
        // mode
        //.SLP            (1'b0),
        //.SD             (1'b0),
        //.AWT            (1'b0),
...
endmodule : sdp_w256x32_r256x32d1_wrap
