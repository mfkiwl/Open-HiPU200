...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_w64x32_r64x32d1_wrap.sv
...
module sdp_w64x32_r64x32d1_wrap (
    input           wr_clk_i,
    input           we_i,
    input [5:0]     waddr_i,
    input [31:0]    wdata_i,
...
`ifdef PLATFORM_ASIC
    ...
    TS6N28HPCPSVTA64X32M8FW sdp_w64x32_r64x32d1_inst (
        // mode
        //.SLP            (1'b0),
        //.SD             (1'b0),
        //.VDD            (1'b1),
...
endmodule : sdp_w64x32_r64x32d1_wrap
