...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_w256x256s_r256x256d1_wrap.sv
...
module sdp_w256x256s_r256x256d1_wrap (
    input           wr_clk_i,
    input           we_i,
    input [7:0]     waddr_i,
    input [255:0]   wdata_i,
...
`ifdef PLATFORM_XILINX
    sdp_w256x256s_r256x256d1 sdp_w256x256_r256x256d1_inst (
        .clka           (wr_clk_i),
        .ena            (1'b1),
...
`ifdef PLATFORM_ASIC
    ...
    TSDN28HPCPA256X64M4MW sdp_w256x64_r256x64d1_inst[3:0] (
        // mode
        //.SLP            ({4{1'b0}}),
        //.SD             ({4{1'b0}}),
        //.AWT            ({4{1'b0}}),
