...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_w32x52_r32x52d1_wrap.sv
...
module sdp_w32x52_r32x52d1_wrap (
    input           wr_clk_i,
    input           we_i,
    input [4:0]     waddr_i,
    input [51:0]    wdata_i,
...
`ifdef PLATFORM_XILINX
    sdp_w32x56_r32x56d1 sdp_w32x56_r32x56d1_inst (
        .clka           (wr_clk_i),
        .ena            (1'b1),
        .wea            ({7{we_i}}),
        .addra          (waddr_i),
...
`ifdef PLATFORM_ASIC
    ...
    TS6N28HPCPSVTA32X52M4FW sdp_w32x52_r32x52d1_inst (
        // mode
        //.SLP            (1'b0),
        //.SD             (1'b0),
        //.VDD            (1'b1),
...
endmodule : sdp_w32x52_r32x52d1_wrap
