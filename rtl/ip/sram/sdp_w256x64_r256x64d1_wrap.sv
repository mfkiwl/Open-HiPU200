...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_w256x64_r256x64d1_wrap.sv
...
module sdp_w256x64_r256x64d1_wrap (
    input           wr_clk_i,
    input           we_i,
    input [7:0]     waddr_i,
    input [63:0]    wdata_i,
...
`ifdef PLATFORM_XILINX
    sdp_w256x64_r256x64d1 sdp_w256x64_r256x64d1_inst (
        .clka           (wr_clk_i),
        .ena            (1'b1),
...
`ifdef PLATFORM_ASIC
    ...
    TSDN28HPCPA256X64M4MW sdp_w256x64_r256x64d1_inst (
        // mode
        //.SLP            (1'b0),
        //.SD             (1'b0),
        //.AWT            (1'b0),
...
endmodule : sdp_w256x64_r256x64d1_wrap
