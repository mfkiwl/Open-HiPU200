...
// ---------------------------------------------------------------------------------------------------------------------
// FILE NAME  : sdp_uhd_w512x64s_r512x64d1_wrap.sv
...
module sdp_uhd_w512x64s_r512x64d1_wrap (
    input           clk_i,
    input           we_i,
    input [8:0]     waddr_i,
    input [63:0]    wdata_i,
...
`ifdef PLATFORM_ASIC
    ...
    TSDN28HPCPUHDB512X64M4MW sdp_w256x64_r256x64d1_inst (
        // mode
        //.AWT            (1'b0),
        //.VDD            (1'b1),
        //.VSS            (1'b0),
...
endmodule : sdp_uhd_w512x64s_r512x64d1_wrap
